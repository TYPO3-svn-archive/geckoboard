...
class Tx_Geckoboard_Widgets_LatestNewPages_NumberAndSecondaryStat
	extends Tx_Geckoboard_Widgets_LatestNewPages {
	...
	protected function getData() {
		...
		$this->data['pageCount'] = $pageRepository->getLatestNewPageCount();
	}
