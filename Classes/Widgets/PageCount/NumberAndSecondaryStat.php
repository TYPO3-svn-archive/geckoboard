...
class Tx_Geckoboard_Widgets_PageCount_NumberAndSecondaryStat extends Tx_Geckoboard_Widgets_PageCount {
	...
	protected function getData() {
		...
		$this->data['pageCount'] = $pageRepository->getCountActiveStandardPages();
	}
